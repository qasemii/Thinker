...
class BackwardDataset(Dataset):
  def __init__(self, ex, template_func):
    self.data = ex
...
if __name__ == '__main__':
  ...
  # Single unified chat template
  def create_template(question, reasoning):
    messages = [
  ...
  dataset = BackwardDataset(training_data, create_template)
